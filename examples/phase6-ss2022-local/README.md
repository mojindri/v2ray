# Phase 6 Shadowsocks 2022 Local Example

This example shows a local Phase 6 Shadowsocks 2022 data path:
...
```sh
cargo test -p integration-tests phase6_ss2022_local_example_transfers_data
```
