# DNS FakeIP + Geo Routing Example

This example shows the DNS FakeIP and geo routing syntax:
...
```sh
cargo run -q -p blackwire -- test -c examples/dns-fakeip-routing/config.json
```
