...
//!
//! This proves the Hysteria2 QUIC path transfers real TCP bytes.
...
const TEST_PASSWORD: &str = "hysteria2-test-password";
...
#[tokio::test]
async fn hysteria2_to_freedom_transfers_data() {
