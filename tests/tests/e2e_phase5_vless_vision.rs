//! Phase 5: VLESS with XTLS Vision flow over plain TCP (blackwire ↔ blackwire).
    ...
    parse_config(format!(
        r#"{{
            ...
            "inbounds": [{{
                ...
                "port": {vless_port},
                "settings": {{
                    "clients": [{{ "id": "{TEST_UUID}", "email": "phase5@example.test", "flow": "{VISION_FLOW}" }}]
                }}
            }}],
...
#[tokio::test]
async fn phase5_vless_vision_plain_tcp_echo() {
