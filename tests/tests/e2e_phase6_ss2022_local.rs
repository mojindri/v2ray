//! Runnable Phase 6 example test: SOCKS5 -> Shadowsocks 2022 -> Freedom.
//!
//! This mirrors `examples/phase6-ss2022-local` with dynamic ports so the test
...
const SS_PASSWORD: &str = "phase6-local-ss2022-password";
...
#[tokio::test]
async fn phase6_ss2022_local_example_transfers_data() {
